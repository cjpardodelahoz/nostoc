...
#SBATCH -c 1
#SBATCH --error=log/get_trnl_set8_%A_%a.err
#SBATCH --output=log/get_trnl_set8_%A_%a.out
...
fna_file=analyses/cyano_genomes_annotation/set8/${bin}/${bin}.fna
out_dir=analyses/cyano_genomes_annotation/set8/${bin}
