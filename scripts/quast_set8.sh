...
#SBATCH --output=log/quast_set8_%A_%a.out
#SBATCH --error=log/quast_set8_%A_%a.err
...
quast --threads 8 -o analyses/genome_qc/set8/quast/${bin} --glimmer \
...
--no-check --no-sv analyses/cyano_genomes/set8/${bin}
