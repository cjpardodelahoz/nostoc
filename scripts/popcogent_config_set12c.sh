...
final_output_dir=analyses/species_delimitation/popcogent/set12c/
mkdir -p ${final_output_dir}

# Path to mugsy and mugsyenv.sh. Please provide absolute path.
mugsy_path=/hpc/group/bio1/carlos/apps/mugsy_x86-64-v1r2.2/mugsy
mugsy_env=/hpc/group/bio1/carlos/apps/mugsy_x86-64-v1r2.2/mugsyenv.sh

# Path to infomap executable. Please provide absolute path.
infomap_path=/hpc/group/bio1/carlos/apps/PopCOGenT/Infomap/Infomap

# Path to genome files.
genome_dir=analyses/cyano_genomes/set12c/
