...
#SBATCH --output=log/concat_ng_set1_na.out
#SBATCH --error=log/concat_ng_set1_na.err
...
-m GTR+G -bb 1000 -bnni -pre analyses/phylogenetics/set1/trees/concat/concat_ng_na
